...
## Les cinq améliorations prioritaires après le lot 41

1. **Préparer l’exploitation sur l’hôte validé** : Docker Linux et la reprise synthétique sont validés en CI et, depuis le 23 septembre, sur le poste Windows via WSL 2. Build, volume neuf, utilisateur 10001 et restauration de onze tables réussis ; base réelle préservée. Voir [validation Windows](WINDOWS-DOCKER-SETUP.md). Restent la supervision prolongée et la copie distante des sauvegardes. Aucun watcher permanent ni VPS n’a été lancé.
2. **Étendre la provenance et compléter la couverture trading** : les lots 39–41 couvrent les sept qualifications `years in`, les deux preuves Jump, 21 champs Crédit Agricole et une qualification Macquarie de sales trading. Prochaine extension bornée : libellés Nomura `Position Specifications → Experience`, avec protections des préférences, alternatives et bornes inversées puis mesure sur les 16 offres ; aucune correction immédiate des sept minima existants n’est justifiée par l’audit. Le cas Jane Street HR, les alternatives académiques générales et les rôles hybrides IMC/Jump/Research Analyst restent à qualifier ; ne pas lever leurs exclusions globalement. Revoir Citadel lorsque son accès public redevient disponible.
...
4. **Poursuivre l'audit des sources** : rétablir la fraîcheur par des collectes bornées avec aperçu d’impact ; le lot 41 est une correction hors ligne et son export du 23 septembre ne comporte aucune source fraîche. Examiner ensuite les catégories ou portails non couverts sur des preuves publiques. Le lot 30 a terminé quatre recherches Citi filtrées sans nouveau chemin retenu ; les autres catégories et la recherche `structuring` restent hors de cette mesure. Reprendre JPMorgan lorsque son accès public devient disponible. Aucune exhaustivité globale n'est revendiquée.
